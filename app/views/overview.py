...
def render() -> None:
    ...
    incomplete = quality.get("inflow_incomplete")
    ...
    st.info(
        ...
        f"**Неполный входящий поток:** как минимум {incomplete} узлов имеют признаки входящих "
        "переводов вне выборки; значения входящего потока — нижняя граница.\n\n"
